...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        key: "modifyTodo",
	        value: function modifyTodo(index) {
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(_TodoMainJs2["default"], { modifyTodo: this.modifyTodo.bind(this), deleteTodo: this.deleteTodo.bind(this), todos: this.state.todos, changeTodoState: this.changeTodoState.bind(this) }),
	                _react2["default"].createElement(_TodoFooterJs2["default"], _extends({ isAllChecked: this.state.isAllChecked }, props, { clearDone: this.clearDone.bind(this), changeTodoState: this.changeTodoState.bind(this) }))
	            );
	        }
	    }]);
	    ...
	    _createClass(TodoHeader, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement('input', { type: 'text', placeholder: 'what\'s your task?', onKeyUp: this.handlerKeyUp.bind(this) })
	            );
	        }
	    }]);
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { ref: 'modifyBtn', onClick: this.handlerModify.bind(this), style: { 'display': 'none' }, className: 'fr' },
	                    '修改'
	                )
	            );
	        }
